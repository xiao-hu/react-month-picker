    ...
    _createClass(MonthPicker, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: ["rmp-container", "table", this.props.className, this.state.showed ? "rmp-show" : ''].join(' ') },
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: ["popup", popupClass, this.props.theme, this.state.showed ? "rmp-show" : ''].join(' ') },
                            pads
                        )
                    )
                )
